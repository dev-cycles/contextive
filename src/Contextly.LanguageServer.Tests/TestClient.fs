module Contextly.LanguageServer.Tests.TestClient
...
open Contextly.LanguageServer.Server
...
let private initAndWaitForConfigLoaded testClientConfig = async {
    ...
    let! reply = "Loading contextly" |> ServerLog.waitForLogMessage logAwaiter
