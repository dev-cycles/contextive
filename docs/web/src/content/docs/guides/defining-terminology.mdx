...
![Example of hovering over the alias `Rule` for the term `Cargo`.](../../../assets/images/simple-term-with-alias.png)
...
![Example of a term with metadata.](../../../assets/images/simple-term-with-metadata.png)
