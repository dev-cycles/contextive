...
Click `Add a new workspace` to get started telling Contextive where your glossary files are.
...
Give your workspace a name (e.g. the name of your company, or team) and then provide the URLs at which your glossary files are located.
...
In the section `Sites to Activate On`, you can enter a set of URL 'match patterns' to define which sites (or paths) to use these glossary files.
