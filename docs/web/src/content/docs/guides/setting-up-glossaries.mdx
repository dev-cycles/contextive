...
![Contextive Browser Extension Welcome Screen](./src/assets/images/browser-extension-welcome.png)

For self-hosted glossary yml files, click `Setup Workspaces`

The next screen links you to this guide:

![Contextive Browser Extension Workspaces Setup](./src/assets/images/browser-extension-empty-settings.png)
...
![Contextive Browser Extension Workspaces Setup](./src/assets/images/browser-extension-add-workspace.png)
...
![Browser Permissions Check](./src/assets/images/browser-extension-permissions-check.png)
...
![Browser Extension Configuration](./src/assets/images/browser-extension-configured-workspace.png)
...
![Deactivating a workspace](./src/assets/images/browser-extension-deactivated-workspace.png)
