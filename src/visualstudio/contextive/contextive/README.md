...
>
> See [known issues](https://github.com/dev-cycles/contextive/blob/v1.16.2/src/visualstudio/contextive/contextive/README.md#known-issues) for others.

## Installation

See [Visual Studio Instructions](https://docs.contextive.tech/community/v/1.16.2/guides/installation/#visual-studio-2022).
