...
To get started with Contextive you need to install the Contextive extension/plugin into your working environment(s).

There are currently two supported working environments, detailed below:
...
There are two ways that development environments support activating the Contextive plugin.
...
After installing Contextive in your IDE of choice, the next step is to [setup your glossary files](../setting-up-glossaries/).  You may also like to install the [Contextive browser extension](#web-browsers) (optional).
...
Contextive is currently available for Chromium-based browsers.  (Firefox support coming soon!)

To install Contextive, visit the [Contextive extension in the Chrome Web Store](https://chromewebstore.google.com/detail/contextive/ddfnfmokhhckieiemhoadefbacpakpjh) and click "Add to Chrome".  (If you are using a different Chromium based browser, it may say the name of that browser, e.g. "Add to Brave".)

Once installed, you can 'pin' Contextive to your toolbar following [these instructions](https://support.google.com/chrome_webstore/answer/2664769?hl=en#showorhide&zippy=%2Cremove-possible-malware%2Carrange-extensions-on-your-toolbar) from the Chrome documentation.

After installing Contextive in your browser of choice, the next step is to [setup your glossary files](../setting-up-glossaries/).  You may also like to install a [Contextive IDE plugin/extension](#development-environments-ides) (optional).
