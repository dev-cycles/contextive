  ...
  - name: Cargo
    ...
    - name: Cargo
      ...
      aliases:
        - unit
      meta:
          "👥 Owner:": "[Team A](https://corporate.wiki/teams/TeamA \"Team A Owns This Term\")"
          "🌐 Ref:": "[Cargo Canonical Reference](https://corporate.wiki/glossary/cargo)"
          "✅": "Approved"
    - name: Leg
...
These can be stored in the `meta` key, and will be shown underneath the definition. Both key and value can contain markdown. For example:
    ...
    - terms:
      - name: Cargo
        ...
        meta:
          ...
          Reference: "[Cargo Canonical Reference](https://corporate.wiki/glossary/cargo)"
```

![Example of a term with metadata.](../../../assets/images/term-meta-data.png)
...
In the <Link href="https://github.com/dev-cycles/contextive/blob/{frontmatter.contextive_version}/docs/web/src/content/docs/guides/defining-terminology.mdx?plain=1#L246">original source</Link> it _does_ have two spaces after `linebreak`
:::
