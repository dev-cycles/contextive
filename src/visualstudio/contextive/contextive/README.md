...
>
> See [known issues](https://github.com/dev-cycles/contextive/blob/v1.17.4/src/visualstudio/contextive/contextive/README.md#known-issues) for others.

## Installation

See [Visual Studio Instructions](https://docs.contextive.tech/community/v/1.17.4/guides/installation/#visual-studio-2022).
