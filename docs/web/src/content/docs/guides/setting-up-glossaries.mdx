...
### Terms relevant in multiple places
...
In this case, the integration folder can contain a glossary file that imports another glossary file. This makes the terminology from the _imported_ file available to files in the folder of the _importing_ file:
...
Multiple files may be imported by defining a list of imports.
